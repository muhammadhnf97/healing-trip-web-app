...
const Footer = () => {
  return (
    <div className='py-3 px-10 w-full h-fit bg-black text-white font-poppins flex flex-col gap-10 justify-start md:h-36 md:flex-row md:text-left text-center'>
